...
Estimated_Point_Gess1=traj(1:10:end,:);     %Outputting data to table
...
Estimated_Point_Gess2=traj(1:10:end,:);     %Outputting data to table
...
Estimated_Point_Guess3=traj(1:10:end,:);     %Outputting data to table
...
Estimated_Point_Guess4=traj(1:10:end,:);     %Outputting data to table
