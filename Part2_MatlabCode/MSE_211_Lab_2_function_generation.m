...
r4x = 1;
r4y = -0.5;
phi(1)=  -0.178;   %In radians
phi(2)=  -1.223;   %In radians
phi(3)=  -2.92;   %In radians
...
f1x= -r2x*cos(inputs.beta(1))+ r2y*sin(inputs.beta(1))- r3x*cos(phi(1))+...
    r3y*sin(phi(1))+ r4x*cos(inputs.gamma(1))- r4y*sin(inputs.gamma(1))+...
    r2x+ r3x- r4x;
f1y= -r2x*sin(inputs.beta(1))- r2y*cos(inputs.beta(1))- r3x*sin(phi(1))-...
    r3y*cos(phi(1))+ r4x*sin(inputs.gamma(1))+ r4y*cos(inputs.gamma(1))+...
    r2y+ r3y- r4y;
f2x= -r2x*cos(inputs.beta(2))+ r2y*sin(inputs.beta(2))- r3x*cos(phi(2))+...
    r3y*sin(phi(2))+ r4x*cos(inputs.gamma(2))- r4y*sin(inputs.gamma(2))+...
    r2x+ r3x- r4x;
f2y= -r2x*sin(inputs.beta(2))- r2y*cos(inputs.beta(2))- r3x*sin(phi(2))-...
    r3y*cos(phi(2))+ r4x*sin(inputs.gamma(2))+ r4y*cos(inputs.gamma(2))+...
    r2y+ r3y- r4y;
f3x= -r2x*cos(inputs.beta(3))+ r2y*sin(inputs.beta(3))- r3x*cos(phi(3))+...
    r3y*sin(phi(3))+ r4x*cos(inputs.gamma(3))- r4y*sin(inputs.gamma(3))+...
    r2x+ r3x- r4x;
f3y= -r2x*sin(inputs.beta(3))- r2y*cos(inputs.beta(3))- r3x*sin(phi(3))-...
    r3y*cos(phi(3))+ r4x*sin(inputs.gamma(3))+ r4y*cos(inputs.gamma(3))+...
    r2y+ r3y- r4y;
