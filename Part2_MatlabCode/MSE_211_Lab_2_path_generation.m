...
r3ax = 0.4; 
r3ay = -0.6;
alpha(1) = -pi/6;	%In radians
alpha(2) = -5*pi/18;  %In radians
alpha(3) = -128*pi/180  %In radians
...
f1x = r2x + r3ax + (inputs.deltax(1)) - r3ax*cos(alpha(1)) + r3ay*sin(alpha(1)) - r2x*cos(inputs.beta(1)) + r2y*sin(inputs.beta(1));
f1y = r2y + r3ay + (inputs.deltay(1)) - r3ay*cos(alpha(1)) - r3ax*sin(alpha(1)) - r2y*cos(inputs.beta(1)) - r2x*sin(inputs.beta(1));

f2x = r2x + r3ax + (inputs.deltax(2)) - r3ax*cos(alpha(2)) + r3ay*sin(alpha(2)) - r2x*cos(inputs.beta(2)) + r2y*sin(inputs.beta(2));
f2y = r2y + r3ay + (inputs.deltay(2)) - r3ay*cos(alpha(2)) - r3ax*sin(alpha(2)) - r2y*cos(inputs.beta(2)) - r2x*sin(inputs.beta(2));

f3x = r2x + r3ax + (inputs.deltax(3)) - r3ax*cos(alpha(3)) + r3ay*sin(alpha(3)) - r2x*cos(inputs.beta(3)) + r2y*sin(inputs.beta(3));
f3y = r2y + r3ay + (inputs.deltay(3)) - r3ay*cos(alpha(3)) - r3ax*sin(alpha(3)) - r2y*cos(inputs.beta(3)) - r2x*sin(inputs.beta(3)); 
...
%WRITE THE RELATIVE EQUATIONS FOR EACH PRECISION POINT
g1x = r4x + r3bx + inputs.deltax(1) - r3bx*cos(alpha(1)) + r3by*sin(alpha(1)) - r4x*cos(gamma(1)) + r4y*sin(gamma(1));
g1y = r4y + r3by + inputs.deltay(1) - r3by*cos(alpha(1)) - r3bx*sin(alpha(1)) - r4y*cos(gamma(1)) - r4x*sin(gamma(1));

g2x = r4x + r3bx + inputs.deltax(2) - r3bx*cos(alpha(2)) + r3by*sin(alpha(2)) - r4x*cos(gamma(2)) + r4y*sin(gamma(2));
g2y = r4y + r3by + inputs.deltay(2) - r3by*cos(alpha(2)) - r3bx*sin(alpha(2)) - r4y*cos(gamma(2)) - r4x*sin(gamma(2));

g3x = r4x + r3bx + inputs.deltax(3) - r3bx*cos(alpha(3)) + r3by*sin(alpha(3)) - r4x*cos(gamma(3)) + r4y*sin(gamma(3));
g3y = r4y + r3by + inputs.deltay(3) - r3by*cos(alpha(3)) - r3bx*sin(alpha(3)) - r4y*cos(gamma(3)) - r4x*sin(gamma(3));
